...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(letters)):
            shift_dict[letters[i]] = letters[(i+shift)%26]
            shift_dict[letters[i].upper()] = shift_dict[letters[i]].upper()
        return shift_dict
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            if count>maximum_words:
                maximum_words = count
                best_shift = shift
                message_text_decrypted = decrypted
        return best_shift, message_text_decrypted
